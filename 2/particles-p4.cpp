...
std::vector<Body> solarSystem = {
    { 1989100000e21, 695508e3,        Vec3f(0,0,0),      Vec3f(0,0,0), 0},
    { 1898187e21,  69911e3,  Vec3f(778.3e9,0,0), Vec3f(0,13.1e3,0), 0},
    { 568317e21,  58232e3,   Vec3f(1427e9,0,0),  Vec3f(0,9.7e3,0), 0},
    { 86813e21,  25362e3,   Vec3f(2871e9,0,0),  Vec3f(0,6.8e3,0), 0},
    { 102413e21,  24622e3, Vec3f(4497.1e9,0,0),  Vec3f(0,5.4e3,0), 0},
    { 5972.4e21,   6371e3,  Vec3f(149.6e9,0,0), Vec3f(0,29.8e3,0), 0},
    { 4867.5e21,   6052e3,  Vec3f(108.2e9,0,0),   Vec3f(0,35e3,0), 0},
    { 641.71e21, 3389.5e3,  Vec3f(227.9e9,0,0), Vec3f(0,24.1e3,0), 0},
    { 330.11e21, 2439.4e3,   Vec3f(57.9e9,0,0), Vec3f(0,47.9e3,0), 0},
...
struct AlloApp : App {
  ...
  void solarSyetmDemo() {
    ...
    for (int i = 0; i < solarSystem.size(); i++) {
      bodies.push_back(solarSystem[i]);
    } 
  }
  ...
  Vec3f gravitationalForce(float m1, float m2, Vec3f p1, Vec3f p2) {
    // force of p1 on p2
    Vec3f diff = p1 - p2;
    Vec3f crossp = p1.cross(p2);
    float r = diff.mag();
    Vec3f dir = crossp.normalize();
